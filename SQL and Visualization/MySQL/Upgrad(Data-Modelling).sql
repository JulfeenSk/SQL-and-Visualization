...
*/
-- Alternate way of creating aprimary key 
CREATE TABLE sales_fact
(
  order_id INT ,
  customer_id INT NOT NULL,
...
REFERENCES order_product_mapping (order_id);
...
-- INSERTING INTO PRODUCT_INFO TABLE
